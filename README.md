...
#### Page 1: Deprivation and Life Expectancy

#### Page 2: Local Authority Analysis

#### Page 3: Healthy Life Expectancy Trends

### Python Charts

| Chart | Preview |
|-------|---------|
| Life expectancy trend by deprivation decile | ![Life expectancy by deprivation decile](output/charts/line_le_by_deprivation_decile.png) |
| LE and HLE gap between most and least deprived | ![LE and HLE gap](output/charts/bar_le_gap_most_least_deprived.png) |
| Health deprivation score by IMD band (heatmap) | ![Health deprivation heatmap](output/charts/heatmap_health_deprivation_by_imd_band.png) |
| IMD score vs life expectancy by local authority | ![IMD vs life expectancy scatter](output/charts/scatter_imd_vs_le_local_authority.png) |
| Healthy life expectancy by sex and deprivation decile | ![HLE by sex and deprivation](output/charts/bar_gender_hle_by_deprivation_decile.png) |
